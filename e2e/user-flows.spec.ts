...
test.describe('User Flows', () => {
  ...
  test('User can navigate to booking page', async ({ page }: { page: Page }) => {
    await page.goto(`${BASE_URL}/`);
...
test.describe('Authentication Flow', () => {
  test('User can register new account', async ({ page }: { page: Page }) => {
  ...
  test('Logged-in user can logout', async ({ page, context }: { page: Page; context: BrowserContext }) => {
    // Login first
    await page.goto(`${BASE_URL}/auth/login`);
    await page.fill('input[type="email"]', process.env.TEST_EMAIL || 'test@example.com');
    await page.fill('input[type="password"]', process.env.TEST_PASSWORD || 'password');
...
test.describe('Booking Flow', () => {
  test.skip('User can create a booking', async ({ page }: { page: Page }) => {
    // Login first
    await page.goto(`${BASE_URL}/auth/login`);
    await page.fill('input[type="email"]', process.env.TEST_EMAIL || 'test@example.com');
    await page.fill('input[type="password"]', process.env.TEST_PASSWORD || 'password');
...
test.describe('Payment Flow', () => {
  test.skip('User can complete payment', async ({ page }: { page: Page }) => {
...
test.describe('API Health', () => {
  test('Backend health endpoint is working', async ({ request }: { request: APIRequestContext }) => {
  ...
  test('Database is accessible', async ({ request }: { request: APIRequestContext }) => {
...
test.describe('Accessibility', () => {
  test('Homepage meets accessibility standards', async ({ page }: { page: Page }) => {
    await page.goto(`${BASE_URL}/`);
...
test.describe('Mobile Responsiveness', () => {
  test('Homepage is responsive on mobile', async ({ page }: { page: Page }) => {
