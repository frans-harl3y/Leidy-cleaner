...
export default function Home() {
  ...
  const getBackgroundClasses = () => {
    switch(theme) {
      case 'light':
        return 'bg-gradient-to-b from-green-50 via-white to-green-50'
      case 'dark':
        return 'bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950'
      case 'high-contrast':
        return 'bg-black'
      case 'pastel':
      ...
      case 'forest':
        return 'bg-gradient-to-b from-green-900 via-green-800 to-green-900'
      default:
        return 'bg-white dark:bg-gray-950'
    }
  }

  const getHeroTitleClasses = () => {
    switch(theme) {
      case 'light':
